...
class Render {
  ...
  networkErrorContainer() {
    ...
    networkError.classList.add(`modal-body`, `modal-network-error`, `hidden-item`);
  ...
  networkErrorButtonsConfirm() {
    ...
    confirm.classList.add(`button`, `modal-button`, `modal-network-error-button`, `modal-network-error-button-confirm`);
  ...
  networkErrorButtonsCancel() {
    ...
    cancel.classList.add(`button`, `modal-button`, `modal-network-error-button`, `modal-network-error-button-cancel`);
  ...
  createNewsDate(news) {
    const date = moment_default()(news.date).locale('ru').format('DD.MM.yy HH:MM');
...
class App {
  ...
  registerEventListeners() {
    this.page.modal.networkError.buttons.confirm.addEventListener('click', event => {
      this.eventListeners.update.click.forEach(item => item(event));
    });
    this.page.main.headerUpdate.addEventListener('click', event => {
      this.eventListeners.update.click.forEach(item => item(event));
    });
    this.page.modal.networkError.buttons.cancel.addEventListener('click', () => {
  ...
  renderMain() {
    ...
    this.page.main.container.append(this.page.main.headerUpdate, this.page.main.headerTitle, this.page.main.newsFeed);
  }
  renderModal() {
  ...
  renderModalNetworkError() {
    this.page.modal.networkError.container = this.render.networkErrorContainer();
    this.renderModalNetworkErrorMain();
    this.renderModalNetworkErrorButtons();
    this.page.modal.networkError.container.append(this.page.modal.networkError.main.container, this.page.modal.networkError.buttons.container);
  }
  renderModalNetworkErrorMain() {
    this.page.modal.networkError.main.container = this.render.networkErrorMainContainer();
    this.page.modal.networkError.main.title = this.render.networkErrorMainTitle();
    this.page.modal.networkError.main.descr = this.render.networkErrorMainDescr();
    this.page.modal.networkError.main.container.append(this.page.modal.networkError.main.title, this.page.modal.networkError.main.descr);
  }
  renderModalNetworkErrorButtons() {
    this.page.modal.networkError.buttons.container = this.render.networkErrorButtonsContainer();
    this.page.modal.networkError.buttons.confirm = this.render.networkErrorButtonsConfirm();
    this.page.modal.networkError.buttons.cancel = this.render.networkErrorButtonsCancel();
    this.page.modal.networkError.buttons.container.append(this.page.modal.networkError.buttons.confirm, this.page.modal.networkError.buttons.cancel);
  }
